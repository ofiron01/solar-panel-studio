...
export const gridBlockTypes = {
    LEVEL_A: {
        ...
        name: 'Level A',
        color: '#ff8b96',
        icon: ({blockSize, text}) => <LevelIcon bgColor="#ff8b96" {...blockSize}>{text}</LevelIcon>,
    },
    LEVEL_B: {
        id: 'level-b',
        name: 'Level B',
        color: '#00caff',
        icon: ({blockSize, text}) => <LevelIcon bgColor="#00caff"  {...blockSize}>{text}</LevelIcon>,
    },
    LEVEL_C: {
        id: 'level-c',
        name: 'Level C',
        color: '#00ce85',
        icon: ({blockSize, text}) => <LevelIcon bgColor="#00ce85"  {...blockSize}>{text}</LevelIcon>,
    },
    LEVEL_D: {
        id: 'level-d',
        name: 'Level D',
        color: '#ffda35',
        icon: ({blockSize, text}) => <LevelIcon bgColor="#ffda35"  {...blockSize}>{text}</LevelIcon>,
    },
